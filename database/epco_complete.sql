-- =============================================
-- EPCO - Script Completo de Base de Datos v3.1
...
-- mysql -u root < epco_complete.sql
-- =============================================
...
-- =============================================
-- DATOS INICIALES: CONFIGURACIÓN SLA
-- Tiempos en minutos
-- =============================================
INSERT INTO sla_settings (priority, first_response_minutes, assignment_minutes, resolution_minutes) VALUES
('urgente', 60, 30, 240),      -- 1h respuesta, 30min asignación, 4h resolución
('alta', 240, 120, 1440),      -- 4h respuesta, 2h asignación, 24h resolución
('media', 480, 240, 2880),     -- 8h respuesta, 4h asignación, 48h resolución
('baja', 1440, 480, 4320);     -- 24h respuesta, 8h asignación, 72h resolución

-- =============================================
-- DATOS INICIALES: NOTICIAS
-- =============================================
...
-- =============================================
-- DATOS INICIALES: BOLETINES INTERNOS
-- =============================================
...
-- =============================================
-- DATOS INICIALES: TICKETS DE EJEMPLO
-- =============================================
INSERT INTO tickets (
...
-- =============================================
-- DATOS INICIALES: HISTORIAL DE TICKETS
-- =============================================
...
-- =============================================
-- DATOS INICIALES: COMENTARIOS DE TICKETS
-- =============================================
...
-- MENSAJE FINAL
-- =============================================
SELECT '✓ Base de datos EPCO v3.1 creada exitosamente!' AS mensaje;
SELECT CONCAT('Total de usuarios: ', COUNT(*)) AS info FROM users;
SELECT CONCAT('Total de artículos KB: ', COUNT(*)) AS info FROM knowledge_base;
SELECT CONCAT('Total de noticias: ', COUNT(*)) AS info FROM news;
SELECT CONCAT('Total de eventos: ', COUNT(*)) AS info FROM events;
SELECT CONCAT('Total de boletines: ', COUNT(*)) AS info FROM bulletins;
SELECT CONCAT('Total de tickets: ', COUNT(*)) AS info FROM tickets;
